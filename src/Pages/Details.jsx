...
function MovieDetails() {
        ...
        if (video?.key) {
            ...
            return(
                <div className="flex mx-auto m-2 justify-center mb-20">
                    <img src={`${process.env.REACT_APP_BASEIMGURL}/${details.backdrop_path}`} alt="img not found" className="mx-auto rounded-lg"/>
                </div>
            )
        }
    }
    ...
    return(
        <div className="container mx-auto p-2">
            ...
            <h1 className="text-center text-6xl font-semibold m-8">{details.title}</h1>
            <MoviePlayer />
            <div>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-3 h-10">
                <div className="flex justify-center text-center p-4 bg-blue-900">
                    ...
                    <h1 className="ml-2 text-sm font-bold text-gray-900 dark:text-gray-300">{round(details.vote_average)}</h1>
                </div>
